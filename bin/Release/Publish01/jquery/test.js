    ...
    for (i = 0; i < ele.length; i++) {
        if (ele[i].key == "Head") {
            ...
            if ((numDtType.includes(dtType[1])) == true || (numDtType.includes(dtType)) == true)
                listtr = listtr + " <li> <span><input type='radio' id='rdoAvg" + i + "' name='rdoHeadNum' value='" + ele[i].vale + "' onchange='rdoAvgchange(" + i + ");'> </span>  <span><input id='chkCol" + i + "' type='checkbox' onchange='chkChange(" + i + ",0);' value='" + ele[i].vale + "'></span>  <span>" + ele[i].vale + "</span></li>";
            else
                listtr = listtr + " <li> <span><input type='radio' id='rdoAvg" + i + "' name='rdoHeadDis' value='" + ele[i].vale + "' onchange='rdoDicchange(" + i + ");'> </span>  <span><input id='chkCol" + i + "' type='checkbox' onchange='chkChange(" + i + ",0);' value='" + ele[i].vale + "'></span>  <span>" + ele[i].vale + "</span></li>";
        }
    }
    $("#lblflName").text(ele[0].fileName);
